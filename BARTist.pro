...
UBUNTU_TRANSLATION_DOMAIN="bartist.bump"
...
aptest.commands = bash $$PWD/BARTist/tests/autopilot/run
aptest.depends  = sub-BARTist

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/BARTist/tests/unit 
unittest.depends  = sub-BARTist
